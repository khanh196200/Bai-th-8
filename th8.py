...
tk.title('welcome')
tk.geometry('350x350')
lb1=Label(tk,text='Hoang Ngoc Khanh',font=('time',20))
lb1.place(x=100,y=50)
lb2=Label(tk,text='msv:18575103010050',font=('time',20))
lb2.place(x=100,y=100)
lb3=Label(tk,text='Date:19/06/2000',font=('time',20))
lb3.place(x=100,y=150)
lb3=Label(tk,text='Nganh electrical electric ',font=('time',20))
